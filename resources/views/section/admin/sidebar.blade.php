        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                @can('user-module')
                    ...
                    <li class="slide {{ (request()->is('referral/registered/user/list*')) ? 'is-expanded' : '' }}">
                        <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                                class="side-menu__icon fa fa-address-book"></i><span class="side-menu__label">Referred User</span><i
                                class="angle fe fe-chevron-right"></i></a>
                        <ul class="slide-menu">
                            @can('user-list')
                                <li><a href="{{ route('admin.referralRegisteredList') }}" class="slide-item {{ (request()->is('admin/user/list*')) ? 'active' : '' }}">Users List</a></li>
                            @endcan
                        </ul>
                    </li>
                @endcan
