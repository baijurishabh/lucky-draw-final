...
<section class="footer">
    <div class="footer_fir_sec">
      ...
      <div class="col-7 footer_menus">
        <div class="col-4">
          <a href="{{route('aboutUs')}}"><h3 style="font-family: p5;">About us</h3></a>
          <a href="{{route('contactUs')}}"><li style="font-family: p5;">Contact us</li></a>
        ...
        <div class="col-4">
           ...
           <a href="{{route('refund_policy')}}"> <li style="font-family: p5;">Refund Policy</li></a>
            ...
            <a href="{{route('termAndCondition_policy')}}"><li style="font-family: p5;">Terms and Condition</li></a>
            {{-- <li style="font-family: p5;">Accessibility</li> --}}
          </div>
      </div>
    </div>
