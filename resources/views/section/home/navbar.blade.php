...
<nav class="navbar navbar-expand-md navbar">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                @if (Request::fullUrl() == url('/'))
                    <a style="font-family: p3;" class="nav-link res" href="#products">{{ __('messages.products') }}</a>
                @else
                    <a style="font-family: p3; " class="nav-link res"
        ...
        <li class="nav-item">
            ...
            <li class="nav-item d-md-none d-block">
                @if (Request::fullUrl() == url('/'))
                    <a style="font-family: p3;" class="nav-link res " href="#anyquery">Advertise with us</a>
                @else
                    <a style="font-family: p3;" class="nav-link res " href="#anyquery">Advertise with us</a>
                @endif
            </li>
        ...
        <div class="right " style="align-items: center;">
            <a style="font-family: p3;" class="nav-link res px-5 mt-2 d-none d-md-flex" href="#anyquery">Advertise with
                us</a>
                <a style="font-family: p3;" class="nav-link res px-5 mt-2 d-none d-md-flex" href="{{route('registerReferral')}}">Register</a>
            <div class="dropdown d-none d-md-flex">

                <button class="dropbtn" style="font-family: p3;">
                    <p class="res mt-3">Language</p>
                </button>
                <div class="dropdown-content">
                    <a href="{{ url('/lang/en') }}" style="font-family: p3;">English</a>
                    <a href="{{ url('/lang/ml') }}" style="font-family: p3;">Malayalam</a>
