                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p style="text-align: left" class="text-dark" style="font-family: p5;">Short
                                            ...
                                            <br>
                                            <p style="text-align: center; font-family: p5;" class="text-primary">Payment QR</p>
                                         <div class="text-center">
                                            <img src="{{asset('assets/images/qr_code/qr_code.png')}}" class="" width="450" alt="">
                                            <p style="text-align: center; font-family: p5;" class="text-primary">Scan this QR and complete the payment</p>
                                         </div>
                                    </div>
