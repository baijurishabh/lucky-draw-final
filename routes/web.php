...
use App\Http\Controllers\auth\user\RegistrationController;
...
Route::get('/contactus', [HomeHomeController::class, 'contactUs'])->name('contactUs');
...
Route::get('/terms-and-condition', [PolicyController::class, 'termAndCondition_policy'])->name('termAndCondition_policy');
...
Route::get('register/referral', [RegistrationController::class, 'registration'])->name('registerReferral');
Route::post('register/referral', [RegistrationController::class, 'registrationPost2'])->name('registerReferralPost');
...
Route::group(['middleware' => ['auth:admin'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::get('referral/registered/user/list', [AdminReferralController::class, 'registered_list'])->name('referralRegisteredList');
